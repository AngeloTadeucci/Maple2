...
public class CharacterNameValidatorTests {
    ...
    public void SpecialCharacters_ShouldReturnNameError() {
        ...
        Assert.That(CharacterNameValidator.ValidateName("Name★"), Is.EqualTo(CharacterCreateError.s_char_err_name));
        Assert.That(CharacterNameValidator.ValidateName("Name."), Is.EqualTo(CharacterCreateError.s_char_err_name));
        Assert.That(CharacterNameValidator.ValidateName("Name!"), Is.EqualTo(CharacterCreateError.s_char_err_name));
        Assert.That(CharacterNameValidator.ValidateName("Name<3"), Is.EqualTo(CharacterCreateError.s_char_err_name));
        Assert.That(CharacterNameValidator.ValidateName("Name♪"), Is.EqualTo(CharacterCreateError.s_char_err_name));
        Assert.That(CharacterNameValidator.ValidateName("Name~"), Is.EqualTo(CharacterCreateError.s_char_err_name));
        Assert.That(CharacterNameValidator.ValidateName("Name*"), Is.EqualTo(CharacterCreateError.s_char_err_name));
        Assert.That(CharacterNameValidator.ValidateName("Name♥"), Is.EqualTo(CharacterCreateError.s_char_err_name));
    ...
    [Test]
    public void NamesWithAccents_ShouldReturnNull() {
        // Names with accented Latin characters should be valid
