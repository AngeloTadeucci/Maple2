...
public sealed class ItemCoupleInfo(long characterId = 0, string name = "", bool isCreator = false) : IByteSerializable, IByteDeserializable {
    ...
    public bool IsCreator { get; private set; } = isCreator;
